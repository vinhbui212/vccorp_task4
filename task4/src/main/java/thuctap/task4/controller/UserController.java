...
public class UserController {
    ...
    @GetMapping("/name")
    public List<User> findByName(@RequestParam String name) throws Exception {
        return userService.searchByName(name);
    }
    @GetMapping("/address")
    public List<User> findByAddree(@RequestParam String addr) throws Exception {
    ...
    @GetMapping("/all")
    public List<User> sxTen() throws Exception {
